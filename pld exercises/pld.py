...
class BaguetteMagique:
    ...
    def __init__(self, maison, proprietaire):
        ...
        Paramètres:
        - maison: str - La maison de Poudlard du propriétaire (Gryffondor,
        Poufsouffle, Serdaigle, Serpentard)
        ...
        self.__matiere = random.choice(BaguetteMagique.bois)
    ...
    def avada_kedavra(self):
        ...
        if self.__maison == "Serpentard":
            ...
            raise Exception(self.__proprietaire + " n'est pas de la maison Serpentard")
    ...
    def enregistrer_baguette(self):
        ...
        BaguetteMagique.baguettes[self.__proprietaire] = {
            ...
            "bois" : self.__matiere,
            "coeur" : self.__coeur,
            "longueur" : str(self.__longueur) + " cm"
            }
